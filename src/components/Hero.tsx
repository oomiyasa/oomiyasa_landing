  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-blue-100/30 filter blur-3xl animate-float opacity-30"></div>
        <div className="absolute bottom-1/3 right-1/3 w-64 h-64 rounded-full bg-purple-100/20 filter blur-3xl animate-float opacity-20" style={{ animationDelay: '2s' }}></div>
      </div>
      
      <div className="container max-w-6xl px-6 md:px-10">
        <div className="flex flex-col items-center text-center space-y-8 md:space-y-10">
          <span className="inline-flex items-center rounded-full bg-secondary px-3 py-1 text-sm font-medium text-secondary-foreground reveal">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl reveal">
            A premium design system that combines form and function into a seamless experience. Every detail has been carefully considered.
          </p>
          ...
          <div className="w-full max-w-4xl mt-16 md:mt-20 relative reveal">
            <div className="aspect-video rounded-lg overflow-hidden shadow-glass border border-white/30 bg-gradient-to-b from-white/80 to-white/40 backdrop-blur-sm">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-full h-full bg-gray-100 animate-pulse-soft"></div>
              </div>
            </div>
